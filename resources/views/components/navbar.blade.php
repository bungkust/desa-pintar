                                    ...
                                    <div class="py-1">
                                        @foreach($item->children as $child)
                                            ...
                                            @if($childHasChildren)
                                                ...
                                                <div class="relative nested-dropdown-parent group">
                                                    <a href="{{ $childUrl }}" 
                                                       class="flex items-center justify-between px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-emerald-600 transition-colors {{ $childIsParentActive ? 'bg-emerald-50 text-emerald-600 font-semibold' : '' }}">
                                                    ...
                                                    <!-- Nested Submenu (Level 2) with invisible padding area -->
                                                    <div class="absolute left-full top-0 hidden group-hover:block z-50 nested-dropdown-container">
                                                        <div class="pl-2">
                                                            <div class="bg-white shadow-lg rounded-lg w-56 border border-gray-200">
                                                                <div class="py-1">
                                                                    @foreach($child->children as $grandchild)
