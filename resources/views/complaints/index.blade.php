...
<x-layouts.page-layout
    ...
    :show-sticky-cta="true">
    
    <x-slot name="stickyCTAContent">
        <a href="{{ route('complaints.form') }}" 
           class="bg-emerald-600 text-white px-6 py-4 rounded-full shadow-lg hover:bg-emerald-700 transition-colors flex items-center gap-2">
